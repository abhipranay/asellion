...
public class CentralizedExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleDataIntegrityException(DataIntegrityViolationException ex, WebRequest webRequest) {
        ApiError apiError;
        if (ex instanceof DuplicateKeyException) {
            apiError = new ApiError(HttpStatus.CONFLICT, ex.getMessage(), ex.getMessage());
        }
        throw ex;
    }
}
