package com.asellion.app.auth;

import com.asellion.app.user.User;
import com.asellion.security.CustomUserService;
...
public class AuthController {
    ...
    public ResponseEntity<?> createAuthenticationToken(@RequestBody AccountCredentials accountCredentials) {
        ...
        logger.info("Loaded user details: '{}' '{}'", userDetails.getEmail(), userDetails.getUsername());
